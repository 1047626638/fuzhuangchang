...
<html>
	...
	<body>
		...
		<div class="login_main">
			<div class="box">
				<div class="left">
					<img src="images/banye.jpg" />
					<p>Clothing Recover</p>
				</div>
				<div class="right">
					<form class="layui-form layui-form-pane" action="login1" method="post">
						<div class="layui-form-item">
							...
							<div class="layui-input-block login_input">
								<input type="text" name="username" required lay-verify="required" autocomplete="on" placeholder="请输入您的用户名" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<input type="radio" name="sex" value="用户" title="用户" lay-filter="userType">
